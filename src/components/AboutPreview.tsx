...
export const AboutPreview = () => {
  return (
    <section className="py-32 bg-secondary/40 relative overflow-hidden border-b border-border/40">
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <AnimatedSection direction="right" className="relative">
            <div className="relative group px-4 lg:px-0">
              ...
              <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(212,175,55,0.15)] bg-card border border-white/5 z-10">
                ...
                <div className="absolute bottom-8 left-8 right-8 z-30">
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-white mb-1 tracking-tight">Innovation First</h3>
                        <p className="text-white/80 text-sm font-medium">Transforming businesses rapidly</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
              ...
              >
                <div className="bg-secondary/90 p-8 rounded-3xl border-2 border-border shadow-[0_0_30px_rgba(255,255,255,0.05)] backdrop-blur-2xl">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <div className="text-base font-bold text-white mb-1 uppercase tracking-wider">Client</div>
                      <div className="text-sm text-white/70 whitespace-nowrap font-light">Satisfaction Rate</div>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          <div className="space-y-10">
            <AnimatedSection>
              <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-card border border-white/5 mb-8 shadow-md">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-tight">
                Grow your <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-primary to-accent">Knowledge.</span>
              </h2>
            </AnimatedSection>
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              {features.map((feature, index) => (
                <AnimatedSection key={feature.title} delay={index * 0.1}>
                  <div className="group bg-card p-6 rounded-2xl border border-white/5 hover:border-primary/40 transition-colors shadow-lg hover:shadow-[0_0_30px_rgba(212,175,55,0.1)] h-full">
