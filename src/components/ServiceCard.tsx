...
export const ServiceCard = ({ icon: Icon, title, description, index = 0 }: ServiceCardProps) => {
  return (
    <motion.div
      ...
      className="bg-card rounded-[2rem] p-10 group border-2 border-border hover:border-primary/50 shadow-lg hover:shadow-[0_15px_40px_-15px_rgba(212,175,55,0.2)] transition-all duration-500 overflow-hidden relative"
    >
      ...
      <div className="absolute bottom-8 right-8 w-10 h-10 rounded-full border border-white/10 flex items-center justify-center opacity-0 group-hover:opacity-100 group-hover:bg-primary/10 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 text-primary">
