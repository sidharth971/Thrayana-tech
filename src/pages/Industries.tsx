        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 flex flex-col items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 mb-6 leading-tight tracking-tight">
              Sector <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-gold-dark animate-pulse">Excellence</span>
            </h1>
            ...
            {industries.map((industry, index) => (
              <AnimatedSection key={industry.title} delay={index * 0.1} direction="up">
                <motion.div
                  ...
                  className="bg-white rounded-[2.5rem] p-8 border border-slate-200 shadow-xl hover:shadow-primary/5 hover:border-primary/40 h-full group transition-all duration-500 relative overflow-hidden flex flex-col"
                >
                  ...
                  <motion.div 
                    ...
                    className="w-16 h-16 rounded-2xl bg-slate-50 border border-slate-200 group-hover:border-primary/50 group-hover:bg-primary/10 flex items-center justify-center mb-8 shadow-sm transition-all duration-500 relative z-10"
                  >
                    <industry.icon className="w-8 h-8 text-primary group-hover:scale-110 transition-transform duration-300" />
                  </motion.div>
                  ...
                  <div className="space-y-3 pt-6 border-t border-slate-100 mt-auto relative z-10">
                    {industry.solutions.map((solution) => (
                      <div key={solution} className="flex items-center gap-3 group/item">
                        <div className="w-2 h-2 rounded-full bg-slate-200 group-hover/item:bg-primary transition-all duration-300" />
                        <span className="text-sm font-semibold text-slate-500 group-hover/item:text-primary transition-colors duration-300">
                          {solution}
                        </span>
                      </div>
                    ))}
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <AnimatedSection direction="up">
              <h2 className="text-4xl lg:text-5xl font-extrabold text-slate-900 mb-6">Technologies We <span className="text-gradient">Master</span></h2>
              ...
              <AnimatedSection key={tech.name} delay={index * 0.05} direction="scale">
                ...
                >
                  <div className="flex flex-col items-center gap-5">
                    <div className="w-16 h-16 flex items-center justify-center p-2 rounded-2xl bg-secondary/50 border border-black/5 group-hover:bg-background transition-colors duration-300">
                      <img
                        src={tech.logo}
                        alt={tech.name}
                    ...
                    <div>
                      <div className="text-base font-bold text-slate-900 group-hover:text-primary transition-colors duration-300 tracking-wide">
                        {tech.name}
                      </div>
                      <div className="text-xs text-primary/70 mt-1 uppercase tracking-wider font-bold">{tech.category}</div>
                    </div>
                  </div>
                </motion.div>
              </AnimatedSection>
